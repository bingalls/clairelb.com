...
<div>
    <section class="container mx-auto mt-8">
        ...
        <p class="md:w-3/4 mx-4 md:mx-auto mb-8 text-center">
    ...
    @foreach ($portfolio->sortBy('order') as $project)
        <div class="container flex flex-col justify-center px-4 sm:px-0 mb-16">
            <a
                class="inline-block mx-auto group no-underline text-grey-darkest text-center"
                href="/portfolio/{{ $project->getFilename() }}"
            >
                <img
                    class="block w-full md:w-auto md:h-lg shadow-lg rounded mb-4 mx-4 md:mx-0 group-hover:lift transition"
